...
由于插件涉及多模式使用，因权限问题、wordpress插件使用惯例及管理，该插件的部署、配置、维护、升级等所有管理功能全部必须在界面化，不能要求用户做linux服务器或wp-cli相关操作！
包括部署及相关功能的配置，包括但不限于支付相关功能的证书、SDK、Key等的部署。若文档中其它信息与次要求冲突，以次条要求为第一优先级，即以次要求为准。
---
...
### **6.1 管理员界面**  
充分考虑三种模式下，插件的部署、使用、管理、维护、升级需求，尤其是“**2.2 全界面化配置管理** ”中提到的：由于插件涉及多模式使用，因权限问题、wordpress插件使用惯例及管理，该插件的部署、配置、维护、升级等所有管理功能全部必须在界面化，不能要求用户做linux服务器或wp-cli相关操作！包括部署及相关功能的配置，包括但不限于支付相关功能的证书、SDK、Key等的部署。若文档中其它信息与次要求冲突，以次条要求为第一优先级，即以次要求为准。
